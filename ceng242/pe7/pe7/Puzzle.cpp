...
*/
Puzzle::Puzzle(int size, int first_row, int first_column): size(size), first_row(first_row), first_column(first_column), top_left(NULL), top_right(NULL), bottom_left(NULL), bottom_right(NULL) {}
