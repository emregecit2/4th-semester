 ...
 */
HighSpeedTrain::HighSpeedTrain(std::string from, std::string to, int eta): from(from), to(to), eta(eta) {}
 ...
 */
HighSpeedTrain::HighSpeedTrain(const HighSpeedTrain &h): from(h.from), to(h.to) , eta(h.eta + 60){}
