...
int main()
{
    ...
    open_course6.finalize();
    open_course7.finalize();
    open_course8.finalize();
    open_course9.finalize();

    for (int i=0; i<freshmans.size(); i++)
        cout << "GPA of Student " << freshmans[i]->getId() << " is: " << freshmans[i]->getGPA() << "." << endl;
    for (int i=0; i<sophomores.size(); i++)
        cout << "GPA of Student " << sophomores[i]->getId() << " is: " << sophomores[i]->getGPA() << "." << endl;
    for (int i=0; i<juniors.size(); i++)
        cout << "GPA of Student " << juniors[i]->getId() << " is: " << juniors[i]->getGPA() << "." << endl;
    for (int i=0; i<seniors.size(); i++)
        cout << "GPA of Student " << seniors[i]->getId() << " is: " << seniors[i]->getGPA() << "." << endl;
...
enum Grade learnGrade(string course_name, int student_id) {
    ...
    Grade grades[7] = {AA, BA, BB, CB, CC, DC, DD};
    string courseNames[10] = {"CENG111_Introduction To Computer Engineering Concepts",
