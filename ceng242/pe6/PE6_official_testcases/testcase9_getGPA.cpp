...
int main()
{
	...
	OpenCourse& open_ceng111 = metu->openCourse(*courses[0], "2020-1", 100, freshmans, sophomores, juniors, seniors);
    open_ceng111.finalize();
...
enum Grade learnGrade(string course_name, int student_id) {
    ...
    if (course_name == "CENG111_Introduction To Computer Engineering Concepts") {
